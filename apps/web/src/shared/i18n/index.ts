...
5. LISTS & TASKS:
   ...
   - Task lists with '- [ ]'.`,
    ...
    snippetTitleRequired: 'The snippet title is required.',
    snippetCodeRequired: 'The snippet code is required.',
...
5. LISTAS Y TAREAS:
   ...
   - Listas de tareas con '- [ ]'.`,
    ...
    snippetTitleRequired: 'El título del fragmento es obligatorio.',
    snippetCodeRequired: 'El código del fragmento es obligatorio.',
    cannotSave: 'No se puede guardar',
    snippetSaved: 'Fragmento guardado correctamente.',
