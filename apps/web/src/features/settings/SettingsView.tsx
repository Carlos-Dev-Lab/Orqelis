...
function SettingsView() {
  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] flex relative overflow-hidden">
      ...
      <AnimatePresence>
        {isSettingsMenuOpen && (
          <motion.div
            ...
            className="@4xl/main:hidden fixed inset-0 z-40 bg-black/50 backdrop-blur-sm"
          />
        )}
      </AnimatePresence>
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-surface-container-lowest/95 backdrop-blur-xl border-r border-on-surface/5 p-4 transform transition-transform duration-300 @4xl/main:relative @4xl/main:translate-x-0 @4xl/main:bg-surface-container-lowest/50",
        ...
        <div className="flex items-center justify-between mb-4 px-3">
          ...
          <button 
            onClick={() => setIsSettingsMenuOpen(false)}
            className="@4xl/main:hidden p-1 hover:bg-on-surface/5 rounded-full"
          >
      ...
      {/* Content */}
      <div className="flex-1 min-w-0 overflow-y-auto custom-scrollbar p-4 @2xl/main:p-6 @5xl/main:p-8">
        <div className="@container w-full max-w-[1600px] mx-auto">
          {/* Mobile Header Toggle */}
          <div className="@4xl/main:hidden flex items-center gap-3 mb-4 @2xl/main:mb-6">
            <button
          ...
          {activeTab === 'general' && (
            ...
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">{t('generalSettings', language)}</h3>
              
              <div className="grid grid-cols-1 @2xl:grid-cols-2 gap-4 @2xl:gap-6">
                {activeWorkspace && (
                  <div className="glass-card rounded-xl p-5 sm:p-6 @2xl:col-span-2">
          ...
          {activeTab === 'account' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">{language === 'es' ? 'Administrar Perfil' : 'Manage Profile'}</h3>
              <ProfileSection />
            </motion.div>
          )}
          ...
          {activeTab === 'cloud' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">Sincronización en la Nube</h3>
              <DatabaseSettings />
            </motion.div>
          )}
          ...
          {activeTab === 'admin' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">Panel de Administración</h3>
              <AdminPanel />
            </motion.div>
          )}
          ...
          {activeTab === 'appearance' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">{t('appearance', language)}</h3>
              
              <div className="grid grid-cols-1 @2xl:grid-cols-2 @5xl:grid-cols-3 gap-4 @2xl:gap-6">
                <div className="glass-card rounded-xl p-5 sm:p-6">
                ...
                {hasAppearanceChanges && (
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="col-span-full flex justify-end pt-1"
                  >
                    <button
          ...
          {activeTab === 'storage' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
            >
              <h3 className="hidden @4xl/main:block text-xl font-bold text-on-surface mb-6">Estado del Almacenamiento</h3>
              <StorageManager />
            </motion.div>
          )}
