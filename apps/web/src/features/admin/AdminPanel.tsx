        ...
        <>
          {isCreatingUser && (
            ...
            >
              ...
              <form onSubmit={handleCreateUser} className="grid grid-cols-1 @2xl:grid-cols-2 @5xl:grid-cols-4 gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4 bg-on-surface/5 p-4 rounded-xl">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full @4xl:w-auto">
          ...
          {(selectedUserStorage || selectedUserSessions.length > 0) && (
            <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-4 @2xl:gap-6 mt-6">
              {selectedUserStorage && (
                <div className="glass-card p-4 sm:p-6 rounded-xl border border-on-surface/10">
                  ...
                  <div className="grid grid-cols-1 @lg:grid-cols-2 @5xl:grid-cols-3 gap-3">
