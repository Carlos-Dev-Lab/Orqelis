...
export function Dashboard() {
  ...
  return (
    <div className="p-4 @2xl:p-6 @5xl:p-8 h-full overflow-y-auto custom-scrollbar">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <header className="mb-6 @5xl:mb-8">
          {activeWorkspace && (
          ...
          <h1 className="text-2xl @2xl:text-3xl font-bold text-on-surface mb-2">{t('dashboardTitle', language)}</h1>
          <p className="text-on-surface-variant">{t('dashboardSub', language)}</p>
        </header>

        {/* Stats Row */}
        <div className="grid grid-cols-2 @2xl:grid-cols-3 @5xl:grid-cols-5 gap-3 @2xl:gap-4 mb-6 @5xl:mb-8">
          {[
            ...
            <motion.div
              ...
              className={cn(
                "glass-card rounded-xl p-4 @2xl:p-5 min-w-0",
                i === 4 && "col-span-2 @5xl:col-span-1"
              )}
            >
        ...
        <div className="grid grid-cols-1 @6xl:grid-cols-3 gap-4 @2xl:gap-6">
          {/* Recent Notes */}
          <div className="@6xl:col-span-2">
            <div className="glass-card rounded-xl p-4 @2xl:p-6">
              ...
              <div className="grid grid-cols-1 @xl:grid-cols-2 @4xl:grid-cols-3 @6xl:grid-cols-2 @8xl:grid-cols-3 gap-4">
          ...
          {/* Right Column */}
          <div className="grid grid-cols-1 @3xl:grid-cols-2 @6xl:grid-cols-1 gap-4 @2xl:gap-6 content-start">
            {/* Technologies */}
            <div className="glass-card rounded-xl p-4 @2xl:p-6">
            ...
            <div className="glass-card rounded-xl p-4 @2xl:p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { label: t('newNote', language), icon: FileText, view: 'editor' as const, action: openNewNote },
            ...
            {orphanNotes.length > 0 && (
              <div className="glass-card rounded-xl p-4 @2xl:p-6 border-warning/20 @3xl:col-span-2 @6xl:col-span-1">
                <div className="flex items-center gap-3 mb-3">
        ...
        {topSnippets.length > 0 && (
          <div className="mt-4 @2xl:mt-6">
            <div className="glass-card rounded-xl p-4 @2xl:p-6">
              ...
              <div className="grid grid-cols-1 @xl:grid-cols-2 @6xl:grid-cols-4 gap-4">
