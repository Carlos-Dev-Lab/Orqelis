  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] relative">
      ...
      >
        ...
        />
        <MiniMap 
          className="!hidden @2xl:!block !bg-surface-container/80 !border-on-surface/10"
          nodeColor={(node) => {
        ...
        <Panel position="top-left">
          <div className="glass-panel rounded-xl p-3 @xl:p-4 space-y-3 @xl:min-w-[200px]">
            ...
            <div className="hidden @xl:block pt-2 border-t border-white/10 space-y-1">
          ...
          <AnimatePresence>
            {showFilters && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="absolute top-full mt-2 right-0 glass-panel rounded-xl p-4 min-w-[180px]"
              >
          ...
          {selectedElement && (
            <Panel position="bottom-right" className="m-4">
              <motion.div
                ...
                className="bg-surface-container-lowest/90 backdrop-blur-xl border border-primary/20 rounded-2xl p-0 overflow-hidden shadow-2xl w-[min(320px,calc(100vw-4rem))]"
              >
                {/* Console Header */}
