...
function SnippetsView() {
  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] flex flex-col overflow-hidden">
      <header className="px-4 @2xl:px-6 py-4 border-b border-on-surface/5">
        <div className="flex items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-semibold text-on-surface truncate">{t('codeSnippets', language)}</h1>
          ...
          <button
            ...
            className="btn-glow shrink-0 whitespace-nowrap px-4 py-2 bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 text-primary font-medium rounded-lg flex items-center gap-2"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 @2xl:p-6 custom-scrollbar">
        <div className="grid grid-cols-1 @2xl:grid-cols-2 @6xl:grid-cols-3 @10xl:grid-cols-4 gap-4">
